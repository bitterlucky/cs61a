...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8b
            place_ant = place.ant
            if place_ant.is_container == True and place_ant.can_contain(self):
                place_ant.store_ant(self)
            elif self.is_container == True and self.can_contain(place_ant):
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        while temp_place != None:
            place_ant = temp_place.ant
            if place_ant != None:
                if place_ant.is_container == True and place_ant.ant_contained != None:
