...
def balanced(m):
    ...
    True
    """
    left_arm_length = length(left(m))
    right_arm_length = length(right(m))
    left_mass = total_mass(end(left(m)))
    right_mass = total_mass(end(right(m)))
    if is_planet(end(right(m))) and is_planet(end(left(m))):
        return left_arm_length * left_mass == right_arm_length * right_mass
    elif is_planet(end(right(m))):
        return left_arm_length * left_mass == right_arm_length * right_mass and balanced(end(left(m)))
    elif is_planet(end(left(m))):
        return left_arm_length * left_mass == right_arm_length * right_mass and balanced(end(right(m)))
    else:
        return left_arm_length * left_mass == right_arm_length * right_mass and balanced(end(right(m))) and balanced(end(left(m)))
