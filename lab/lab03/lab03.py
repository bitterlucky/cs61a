...
def double_eights(n):
    ...
    True
    """
    def helper(n, is_last_digit_equal_eight):
        if n == 8 and is_last_digit_equal_eight == True:
            return True
        elif n < 10 and n != 8:
            return False
        elif n >= 10:
            if n % 10 == 8 and is_last_digit_equal_eight == True:
                return True
            elif n % 10 != 8:
                return helper(n // 10, False)
            elif n % 10 == 8 and is_last_digit_equal_eight == False:
